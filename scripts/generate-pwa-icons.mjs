...
const source = join(publicDir, "home-stock-logo.png");
const THEME_COLOR = "#4db155";
...
// Maskable: safe-area padding (~20%) since platforms crop to a circle/squircle.
const maskableSize = 512;
const logoSize = Math.round(maskableSize * 0.6);
await sharp({
  create: { width: maskableSize, height: maskableSize, channels: 4, background: THEME_COLOR },
})
  .composite([
