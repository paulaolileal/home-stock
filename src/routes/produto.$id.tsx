          ...
          <div className="space-y-3 rounded-3xl bg-card p-5 ring-1 ring-border">
            ...
            <Row label="Mínimo">
              <input
                ...
                onChange={(e) =>
                  updateProduct(product.id, { minQuantity: Math.max(0, Number(e.target.value)) })
                }
            ...
            <Row label="Ideal">
              <input
                ...
                onChange={(e) =>
                  updateProduct(product.id, { idealQuantity: Math.max(0, Number(e.target.value)) })
                }
                className="w-16 bg-transparent text-right font-mono text-sm font-bold outline-none"
              />
            </Row>
