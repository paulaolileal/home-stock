...
import { useProducts, needsShopping } from "@/lib/store";

export const Route = createFileRoute("/compras")({
  head: () => ({
    meta: [
      { title: "Lista de compras — Home Inventory" },
      {
        name: "description",
        content:
          "Arraste para adicionar ao carrinho. Sua lista é calculada em tempo real a partir do inventário.",
      },
    ],
  }),
  component: Compras,
