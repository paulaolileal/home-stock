    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-full bg-foreground px-5 py-2.5 text-sm font-semibold text-background transition-colors"
          >
            Voltar ao início
          </Link>
        </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Home Inventory — estoque doméstico em segundos" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "Home Inventory" },
      { name: "theme-color", content: "#fafafa" },
      { property: "og:title", content: "Home Inventory — estoque doméstico em segundos" },
      {
        property: "og:description",
        content:
          "Inventário e lista de compras em um toque. Simples, rápido e bonito.",
      },
